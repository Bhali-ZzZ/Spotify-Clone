...
const AddSong = () => {
  ...
  return loading ? (
    ...
    <form onSubmit={submitHandler} className='flex flex-col items-start gap-8 text-gray-600 pb-10'>
      ...
      <div className='flex flex-col gap-2.5'>
        ...
        <input type='text' onChange={(e)=>setDesc(e.target.value)} value={desc} className='bg-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-[max(40vw,250px)]' placeholder='Type here' required/>
      </div>
      <div className='flex flex-col gap-2.5'>
        <p>Album</p>
